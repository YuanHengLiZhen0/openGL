...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model1 = glm::rotate(model1, glm::radians((float)glfwGetTime() * 10.0f), glm::vec3(0.0f, 1.0f, 0.0f));
  ...
  // draw scene as normal
		...
		model = glm::rotate(model, glm::radians((float)glfwGetTime() * 10.0f), glm::vec3(0.0f, 1.0f, 1.0f));
